...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2024 a las 21:57:26
...
CREATE TABLE `noticias` (
  ...
  `fecha` date NOT NULL,
  `estado` enum('activa','inactiva','borrador','finalizada') NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('Editor','Validador','Editor, Validador') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `noticias`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_editor` (`editor_id`),
