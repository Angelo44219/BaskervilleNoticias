...
<div class="contenido">
    <div class="card rounded-0" style="max-width: 600px;">
        ...
        <div class="card-body">
            ...
            <form method="post" action="<?php echo base_url('noticias/rechazar/' . $noticia['id']); ?>" autocomplete="off" enctype="multipart/form-data">
                ...
                <select class="form-control" id="estado" name="estado" required>
                    <option value="rechazada">Rechazar noticia</option>
                </select>

                <div class="mb-3 mt-3">
                    <label for="titulo" class="form-label" name="titulo">Escribir motivo</label>
                    <input type="text" class="form-control" id="motivo" name="motivo" required>
                </div>

                <br><br>
                <button type="submit" class="btn btn-danger">Rechazar noticia</button>
